...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/06/19 11:49:33 by asharafe          #+#    #+#             */
/*   Updated: 2025/09/20 21:26:20 by asharafe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	custom_print_address(void *content);
...
int	main(void)
{
	...
	while (current)
	{
		printf("Node content: %s (address: %p)\n", (char *)current->content, 
		current->content);
		current = current->next;
	}
	printf("After applying f - function\n");
	ft_lstiter(lst, custom_print_address);
